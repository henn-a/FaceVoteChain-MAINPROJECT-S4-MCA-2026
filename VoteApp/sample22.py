...
def encryption(fn):
    ...
    #
    image11.save("static/share1/"+fn)
    image22.save("static/share2/"+fn)

def decription(fn):
    print(fn,"===========")

    try:
        image = Image.open("static/share1/"+fn)
        image11 = Image.open("static/share2/"+fn)
        image22 = Image.open(r"E:\e_voting\media/"+fn)
        image1 = Image.open("static/share1/"+fn)
        image2 = Image.open(r"E:\e_voting\media/"+fn)
        ...
        image.save("static/final/" + fn)
        return "true"
    except Exception as e:
        print(e)
        return "false"
encryption("IMG_20240331_091922_613.jpg")


decription("IMG_20240331_091922_613.jpg")
# def makeimg(st,fn):
#     my_image = Image.open("sample.png")
#     title_font = ImageFont.truetype('Poppins-Medium.ttf', 80)
#     image_editable = ImageDraw.Draw(my_image)
#     image_editable.text((35, 15), st, (0, 0, 0), font=title_font)
#     my_image.save("static/images/"+fn)
#
# makeimg("dsgdfgdfg","IMG-20240405-WA0017.jpg")
